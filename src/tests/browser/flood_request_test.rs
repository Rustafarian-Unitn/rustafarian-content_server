...
pub mod flood_request_test {
    ...
    use wg_2024::{
        config::Drone, network::SourceRoutingHeader, packet::{FloodRequest, Fragment, NodeType, Packet, PacketType}
    };
    ...
    fn flood_request_test() {
        ...
        let file_request = Packet::new_flood_request(
        ...
        let flood_request_2=FloodRequest{
            flood_id:1,
            initiator_id: 21,
            path_trace: vec![(4, NodeType::Drone),(3, NodeType::Drone),(1, NodeType::Server)]
        };
